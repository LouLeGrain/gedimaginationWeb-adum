...
//Début des vérifications de sécurité...
            ...
            $_SESSION['infos']['warning'] = 'Vous n\'avez pas rentré les 4 premiers chiffres d\'un ticket de caisse';
        }
        header('Location: tableaudebord.php');
        exit();
    }
    ...
    public static function isVotingTime()
    {
        ...
        // $dateEndVote = new DateTime("03/31/2018 last day of +1 month", new DateTimeZone('Europe/Paris'));
        $dateEndVote = new DateTime("03/31/2019 last day of +1 month", new DateTimeZone('Europe/Paris'));
        $today = new DateTime("now", new DateTimeZone('Europe/Paris'));

        if ($today > $dateBeginningVote && $today < $dateEndVote) {
            return true;
        } else {
            return false;
        }
    ...
    public static function isParticipationTime()
    {
        $dateBeginningContest = new DateTime("03/03/2018", new DateTimeZone('Europe/Paris'));
        // $dateEndContest = new DateTime("03/31/2018",new DateTimeZone('Europe/Paris'));
        $dateEndContest = new DateTime("03/31/2019", new DateTimeZone('Europe/Paris'));
        $today = new DateTime("now", new DateTimeZone('Europe/Paris'));

        if ($today > $dateBeginningContest && $today < $dateEndContest) {
            return true;
        } else {
            return false;
        }
